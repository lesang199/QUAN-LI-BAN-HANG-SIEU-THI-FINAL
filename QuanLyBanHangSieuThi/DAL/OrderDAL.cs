...
namespace QuanLyBanHangSieuThi.DAL
{
    public class OrderDAL
    {
        ...
        private string _dataFile = Path.Combine(Global.DATA_PATH, nameof(Order) + ".json");
        ...
        // Phương thức nạp danh sách Order từ file JSON
        public List<Order> Load()
        {
            ...
            return new List<Order>(); // Trả về danh sách trống nếu không có file
        }

        // Phương thức lưu danh sách Order vào file JSON
